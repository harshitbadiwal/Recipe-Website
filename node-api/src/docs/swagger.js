      ...
      schemas: {
        ...
        Recipe: {
          ...
          properties: {
            ...
            categoryNames: { type: 'array', items: { type: 'string' }, example: ['Non-Veg', 'Main Course'] },
            categories: { type: 'array', items: { type: 'string' }, example: ['65d1a2b3c4d5e6f7a8b9c0d3'] },
            ...
            scheduledAt: { type: 'string', example: '2026-09-05T14:30:00.000Z' },
          },
        },
        Category: {
          type: 'object',
              ...
              'multipart/form-data': {
                schema: {
                  ...
                  properties: {
                    ...
                    category: { type: 'string', example: 'Non-Veg', description: 'Primary Category ID, slug, or name' },
                    categories: { type: 'string', example: '["Non-Veg", "Main Course"]', description: 'JSON array string of category IDs, slugs, or names' },
                    ...
                    isFeatured: { type: 'boolean', example: true },
                    isPublished: { type: 'boolean', example: true },
                    isScheduled: { type: 'boolean', example: true, description: 'Set true to schedule publishing for a future date/time' },
                    scheduledDate: { type: 'string', example: '2026-09-05', description: 'Publish date YYYY-MM-DD' },
                    scheduledTime: { type: 'string', example: '14:30', description: 'Publish time HH:mm' },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    categories: { type: 'array', items: { type: 'string' }, example: ['Non-Veg', 'Main Course'] },
                    image: { type: 'string', example: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&h=300&fit=crop' },
                    prepTime: { type: 'number', example: 20 },
                    cookTime: { type: 'number', example: 40 },
                    servings: { type: 'number', example: 4 },
              ...
              'multipart/form-data': {
                schema: {
                  ...
                  properties: {
                    ...
                    categories: { type: 'string', description: 'JSON array string of category names or IDs' },
